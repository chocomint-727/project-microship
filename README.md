...
-To enter get information for an anime based on the title, run the flask app and add /title?title=(name of title) to the website URL.

-To filter the data by a genre, run the flask app and add /genres?genre=(genre to search by) to the website URL. When on the page of anime from that genre, click on one of the rows to go to a page that displays the information about that anime in a more organized way.
...
-To get information about a random anime, run the flask app and add /random to the website URL.
