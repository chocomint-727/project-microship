...
- Wrote the SQL Queries for DB access
...
- Wrote the CSS, steered the design direction
- Worked with buttons and site navigation
- Added interactivity and created responsive site elements where applicable
